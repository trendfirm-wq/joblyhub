...
await job.save();
    ...
    const payload = {
      ...
      returnUrl: `${process.env.HUBTEL_RETURN_URL}?reference=${reference}`,
      cancellationUrl: `${process.env.HUBTEL_CANCEL_URL || process.env.HUBTEL_RETURN_URL}?reference=${reference}`,
