  ...
  try {
    await sendEmail({
     to: process.env.ADMIN_ALERT_EMAIL,
      subject: "🔔 New Employer Awaiting Verification | JoblyHub",
      html: `
        <div style="font-family:Arial,sans-serif;background:#f5f7fb;padding:30px;">
          <div style="max-width:700px;margin:auto;background:#ffffff;border-radius:16px;padding:30px;border:1px solid #e5e7eb;">
            ...
            <p style="color:#4b5563;font-size:15px;">
              A new employer has registered on <strong>JoblyHub</strong>
              and is awaiting verification.
            </p>

            <table style="width:100%;border-collapse:collapse;margin-top:25px;">
              <tr>
                <td style="padding:10px;font-weight:bold;">Employer Name</td>
                <td style="padding:10px;">${user.name}</td>
              </tr>

              <tr style="background:#f9fafb;">
                <td style="padding:10px;font-weight:bold;">Company</td>
                <td style="padding:10px;">${user.companyName}</td>
              </tr>

              <tr>
                <td style="padding:10px;font-weight:bold;">Industry</td>
                <td style="padding:10px;">${user.companyIndustry}</td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding:10px;">${user.phone || "Not provided"}</td>
              </tr>
            ...
            <div style="margin-top:30px;padding:18px;background:#fff7ed;border-left:4px solid #f59e0b;border-radius:8px;">
              <strong>Action Required</strong>
              <p style="margin:8px 0 0;">
                Please log in to the JoblyHub Admin Dashboard and verify this employer before they can publish job vacancies.
              </p>
            </div>
<div style="text-align:center;margin-top:30px;">
  <a
    href="${process.env.ADMIN_DASHBOARD_URL}"
    style="
      background:#0f766e;
      color:#ffffff;
      padding:14px 28px;
...
This notification was automatically generated by JoblyHub.
Please review and verify the employer before they can publish job vacancies.
</p>
          </div>
        </div>
      `,
   ...
   console.log(
  `Employer verification email sent to ${process.env.ADMIN_ALERT_EMAIL}`
);
  } catch (emailError) {
    console.error(
